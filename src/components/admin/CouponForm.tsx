...
const SectionHeader = ({ title, icon: Icon, colorClass = "text-blue-600" }: any) => (
  <div className="px-8 py-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 flex items-center gap-3">
    <div className={`p-2 rounded-xl bg-white dark:bg-slate-800 shadow-sm ${colorClass}`}>
      <Icon size={16} />
    </div>
    <h2 className="text-[11px] font-black text-slate-900 dark:text-white uppercase tracking-[0.2em]">{title}</h2>
  </div>
);
...
export default function CouponForm({ initialData, mode }: CouponFormProps) {
  ...
  return (
    <div className="w-full pb-32 animate-in fade-in duration-700 bg-slate-50/50 dark:bg-slate-950 min-h-screen">

      {/* Sticky Header */}
      <div className="sticky top-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 py-5 px-6 shadow-sm">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              onClick={() => router.push('/admin/coupons')}
              className="h-11 w-11 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-blue-600 transition-all shadow-sm"
            >
              <ArrowLeft size={18} />
            </button>
            <div>
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => router.push('/admin/coupons')} className="px-5 py-3 rounded-xl text-xs font-black uppercase tracking-wider text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all">Discard</button>
            <button
              form="coupon-form"
              type="submit"
              disabled={submitting}
        ...
        <form id="coupon-form" onSubmit={handleSubmit} className="space-y-8">
                ...
                <InputWrapper label="Coupon Code" helpText="The unique promo code string customers enter at checkout.">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-14 pl-12 pr-6 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 focus:border-blue-500 focus:ring-4 ring-blue-500/5 outline-none font-mono font-black text-slate-900 dark:text-white text-sm transition-all"
                    />
                  </div>
                </InputWrapper>
                ...
                <InputWrapper label="Benefit Type" helpText="Select dynamic discount mechanics.">
                  <div className="relative">
                    <select
                      ...
                      className="w-full h-14 px-6 rounded-2xl bg-slate-50 dark:bg-slate-955 border border-slate-200 dark:border-slate-800 focus:border-blue-500 outline-none font-bold text-slate-800 dark:text-slate-100 text-sm appearance-none"
                    >
                ...
                <InputWrapper label="Benefit Value" helpText="Enter discount percentage or flat rupee value.">
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      className="w-full h-14 pl-12 pr-6 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 focus:border-blue-500 outline-none font-bold text-slate-900 dark:text-white text-sm transition-all disabled:opacity-40"
                    />
                  </div>
                </InputWrapper>
                ...
                <InputWrapper label="Min Order Value (₹)" helpText="Minimum subtotal required to validate promotion.">
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      className="w-full h-14 pl-12 pr-6 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 focus:border-blue-500 outline-none font-bold text-slate-900 dark:text-white text-sm transition-all"
                    />
                  </div>
                </InputWrapper>
                ...
                <InputWrapper label="Max Discount Cap (₹)" helpText="Only applicable for Percentage type discounts.">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-14 pl-12 pr-6 rounded-2xl bg-slate-50 dark:bg-slate-955 border border-slate-200 dark:border-slate-800 focus:border-blue-500 outline-none font-bold text-slate-900 dark:text-white text-sm transition-all disabled:opacity-30"
                    />
                  </div>
                </InputWrapper>
              </div>
                ...
                <InputWrapper label="Lifespan & Expiration" helpText="The date/time after which this coupon becomes completely invalid.">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-14 pl-12 pr-6 rounded-2xl bg-slate-50 dark:bg-slate-955 border border-slate-200 dark:border-slate-800 focus:border-blue-500 outline-none font-bold text-slate-900 dark:text-white text-sm transition-all"
                    />
                  </div>
                </InputWrapper>
              </div>
              ...
              <InputWrapper label="Coupon Scope / Type" helpText="Specify target boundaries for dynamic coupon validation.">
                <div className="relative">
                  <select
                    ...
                    onChange={e => setFormData({ ...formData, couponScope: e.target.value })}
                    className="w-full h-14 px-6 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 focus:border-blue-500 outline-none font-black text-slate-900 dark:text-white text-sm appearance-none"
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full h-10 pl-10 pr-4 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold bg-slate-50 dark:bg-slate-950 text-slate-850 dark:text-white outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 transition-all"
                      />
                    </div>
                  </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="min-w-0">
                              <p className="text-[11px] font-black text-slate-850 dark:text-white truncate">{b.name}</p>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="min-w-0 flex-1">
                              <p className="text-[11px] font-black text-slate-855 dark:text-white truncate">{p.name}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full h-10 pl-10 pr-4 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold bg-slate-50 dark:bg-slate-955 text-slate-800 dark:text-white outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 transition-all"
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 max-h-60 overflow-y-auto pr-2 no-scrollbar">
                      ...
                      .map((c: any) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-[11px] font-black text-slate-855 dark:text-white truncate">{c.name}</p>
                          </button>
                        );
                      })}
                  </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <InputWrapper label="Global Usage Limit" helpText="Total number of times this coupon can be used across all shoppers.">
                  <input
                    ...
                    className="w-full h-14 px-6 rounded-2xl bg-slate-50 dark:bg-slate-955 border border-slate-200 dark:border-slate-800 focus:border-blue-500 outline-none font-bold text-slate-900 dark:text-white text-sm transition-all"
                  />
                </InputWrapper>
              ...
              <div className="bg-slate-50 dark:bg-slate-955 rounded-2xl p-6 border border-slate-100 dark:border-slate-850">
                <h3 className="text-xs font-black uppercase text-slate-700 dark:text-slate-355 tracking-wider mb-4">Eligibility</h3>
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input
                    type="checkbox"
                    checked={formData.firstOrderOnly}
                    onChange={e => setFormData({ ...formData, firstOrderOnly: e.target.checked })}
                    className="h-5 w-5 rounded-lg border-slate-200 dark:border-slate-800 text-blue-600 focus:ring-blue-500"
                  />
                  <div>
                    <p className="text-xs font-black text-slate-855 dark:text-white group-hover:text-blue-500 transition-colors">First Order Only Restriction</p>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="relative w-full sm:w-64">
                      ...
                      <input
                        ...
                        className="w-full h-9 pl-9 pr-3 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold bg-white dark:bg-slate-900 text-slate-800 dark:text-white outline-none focus:border-red-400 focus:ring-2 focus:ring-red-400/10 transition-all"
                      />
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-2 max-h-32 overflow-y-auto p-3 border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-955">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2 max-h-40 overflow-y-auto p-3 border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-955">
