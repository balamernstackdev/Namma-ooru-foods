    ...
    <div className="max-w-4xl mx-auto pb-32">
       ...
       <div className="flex items-center justify-between mb-16">
          ...
          <div className="text-center">
             <h2 className="text-3xl font-black text-emerald-950 dark:text-white tracking-tighter uppercase">Calibrate Scale</h2>
          ...
          >
             {isLoading ? 'Calibrating...' : <><Save size={20} /> Commit Changes</>}
          </button>
       </div>
