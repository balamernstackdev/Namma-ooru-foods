      ...
      <div className="max-w-4xl mx-auto pb-32">
         ...
         <div className="flex items-center justify-between mb-16">
            ...
            <div className="text-center">
               <h2 className="text-3xl font-black text-emerald-950 dark:text-white tracking-tighter uppercase"> Create Categoryr</h2>
               <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Expanding Store Taxonomy for Brand #{user?.brandId}</p>
            </div>
            <button
               form="category-form"
               disabled={isLoading}
            ...
            >
               {isLoading ? 'Defining...' : <><Save size={20} className="text-amber-400" /> Create Taxonomy</>}
            </button>
         </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-10 md:p-14 border border-slate-100 dark:border-slate-800 space-y-12 shadow-sm">
               ...
               <div className="space-y-10">
                  <div className="flex items-center gap-4 text-emerald-950 dark:text-white">
                     ...
                     <h3 className="text-xl font-black tracking-tight">Category DNA</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                     ...
                     <div className="md:col-span-2 space-y-4">
                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Description / Narrative</label>
                        <textarea
                           required
                           rows={5}
               ...
               <div className="p-8 rounded-[2rem] bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800 flex items-center gap-6">
