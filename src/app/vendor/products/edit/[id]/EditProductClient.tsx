      ...
      <div className="max-w-5xl mx-auto pb-32">
         ...
         <div className="flex items-center justify-between mb-16">
            ...
            <div className="text-center">
               <h2 className="text-3xl font-black text-emerald-950 dark:text-white tracking-tighter uppercase">Product Overview</h2>
               <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Refining Inventory Integrity for Reseller #{user?.brandId}</p>
            </div>
            <button
               form="product-form"
               disabled={isLoading}
            ...
            <div className="lg:col-span-1 space-y-12">
               ...
               <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-10 border border-slate-100 dark:border-slate-800 space-y-8 shadow-sm text-emerald-950 dark:text-white">
                  <div className="flex items-center gap-3">
                     ...
                     <h3 className="text-lg font-black tracking-tight">Upload or manage product images</h3>
                  </div>
