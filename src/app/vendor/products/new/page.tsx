...
export default function CreateProduct() {
  ...
  const [variants, setVariants] = useState([{ name: 'Standard', price: '', stock: '50' }]);
  ...
  return (
    <div className="max-w-5xl mx-auto pb-32">
       ...
       <div className="flex items-center justify-between mb-16">
          <button 
             onClick={() => router.back()}
             className="h-14 w-14 rounded-full bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 flex items-center justify-center text-emerald-950 dark:text-white hover:bg-slate-50 transition-all"
          >
             <ArrowLeft size={20} />
          </button>
             ...
             <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-10 md:p-14 border border-slate-100 dark:border-slate-800 space-y-10 shadow-sm">
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-4 text-emerald-950 dark:text-white">
                      ...
                      <h3 className="text-xl font-black tracking-tight">Weight & Inventory Scale</h3>
                   </div>
                   <button 
                      type="button"
                   ...
                   <AnimatePresence initial={false}>
                      {variants.map((variant, idx) => (
                         <motion.div 
                            ...
                            className="flex flex-col md:flex-row gap-4 p-6 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-800 relative group overflow-hidden"
                         >
                            <div className="flex-1 space-y-2">
                               <input 
                                  placeholder="Variant Label (e.g. 500g)"
                                  className="w-full h-12 px-5 bg-white dark:bg-slate-900 rounded-xl outline-none font-bold text-[13px] border border-transparent focus:border-amber-400 transition-all"
                                  value={variant.name}
                                  onChange={e => {
                                     const v = [...variants];
                ...
                <div className="space-y-6">
                   <div className="space-y-3">
                      ...
                      <div className="relative">
                         <select 
                            required
                            className="w-full h-14 px-6 pr-12 rounded-xl bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-amber-400 outline-none transition-all font-black text-[11px] uppercase tracking-widest appearance-none"
                   ...
                   <div className="space-y-3">
                      ...
                      <input 
                         ...
                         type="number" 
                         placeholder="₹ MSRP"
                         className="w-full h-14 px-6 rounded-xl bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-amber-400 outline-none transition-all font-black text-xs"
                   ...
                   <div className="space-y-4">
                      ...
                      <div className="flex gap-2">
                         ...
                         <button 
                            ...
                            className="h-12 w-12 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center hover:bg-slate-100 transition-all"
                         >
                            <Plus size={18} />
                         </button>
                      </div>
