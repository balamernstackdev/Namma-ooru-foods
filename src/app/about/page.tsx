...
export default function AboutPage() {
  return (
    <div className="flex flex-col gap-16 md:gap-32 bg-white w-full overflow-x-hidden pb-24 md:pb-40">

      {/* Hero Section */}
      <section className="relative w-full overflow-hidden bg-emerald-950" style={{ height: '60vh', minHeight: '500px' }}>
        ...
        <div className="relative z-20 w-full h-full flex items-center justify-center text-center">
          <div className="standard-container py-20 md:py-32 px-6">
            <span className="text-amber-400 text-[9px] md:text-xs font-black uppercase tracking-[0.4em] md:tracking-[0.5em] mb-6 md:mb-12 inline-block">Our Heritage • Our Roots</span>
            <h1 className="text-4xl md:text-7xl lg:text-9xl font-black text-white leading-tight md:leading-[1] tracking-tighter mb-8 md:mb-20">
              Namma Orru <br />
      ...
      <section className="w-full bg-white py-20 md:py-40 lg:py-56">
      ...
      {/* Values Section */}
      <section className="w-full bg-gray-50 py-20 md:py-40">
        <div className="standard-container">
          <div className="text-center mb-16 md:mb-32">
            <span className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em] text-amber-500 mb-6 md:mb-8 inline-block">Our Core Values</span>
            <h2 className="text-3xl md:text-6xl lg:text-7xl font-black text-emerald-950 tracking-tighter leading-tight px-4">Everything we do is built <br className="hidden md:block" /> on trust and quality.</h2>
          </div>
      ...
      {/* Quote Section */}
      <section className="w-full bg-emerald-950 py-40 md:py-64 relative overflow-hidden">
        ...
        <div className="standard-container text-center relative z-10">
          <h2 className="text-3xl md:text-7xl lg:text-8xl font-black text-white tracking-tighter mb-16 md:mb-48 leading-tight">
      ...
      {/* CTA Section */}
      <section className="w-full bg-white py-20 md:py-40">
        <div className="standard-container">
          <div className="bg-emerald-50 rounded-[3rem] md:rounded-[4rem] p-10 md:p-32 text-center relative overflow-hidden border border-emerald-100/50 shadow-sm">
            ...
            <h2 className="text-3xl md:text-7xl font-black text-emerald-950 mb-12 md:mb-24 relative z-10 leading-tight tracking-tighter">
