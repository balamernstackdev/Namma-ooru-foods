...
export const metadata: Metadata = {
  title: 'Namma Orru Foods — Blog | Organic Farming & Nutrition Insights',
  description: 'Discover stories from our farms, nutrition tips, and the journey of traditional food — straight from the harvesters at Namma Orru Foods.',
};
...
export default async function BlogPage() {
  ...
  return (
    <div className="mx-auto w-full py-12" style={{ maxWidth: '1400px', paddingLeft: '5%', paddingRight: '5%' }}>
      <div className="mb-12">
        <p className="text-[10px] uppercase font-black tracking-widest text-amber-600 mb-2">The Harvest Journal</p>
      ...
      {posts.length === 0 ? (
        <div className="bg-white rounded-[2rem] border border-slate-100 p-20 text-center shadow-sm">
          ...
          <p className="text-slate-300 text-sm mt-2">Our farming stories are being harvested. Check back soon!</p>
        </div>
      ) : (
