  ...
  return (
    <div className="flex flex-col bg-white w-full overflow-x-hidden">
      ...
      <main>
        ...
        <section className="pt-4 md:pt-8 pb-8 md:pb-12 bg-white border-y border-slate-50 flex justify-center">
          <div className="standard-container">
        ...
        <section className="relative overflow-hidden section-spacing bg-emerald-950 flex justify-center min-h-[50vh] md:min-h-[70vh] py-20 md:py-40">
          <div className="absolute inset-0 z-0 opacity-20">
            <Image
              src="/ai_images/cinematic_farm_1776230966841.png"
              alt="Cinematic Organic Farm"
              fill
              className="object-cover"
            />
          </div>
          <div className="standard-container relative z-10 flex flex-col items-center justify-center text-center">
            <div className="max-w-4xl space-y-6 md:space-y-12">
              ...
              <p className="text-lg md:text-2xl text-emerald-50/70 font-medium leading-relaxed max-w-2xl mx-auto">
                From pickles to millets, we've built a platform for local businesses to reach your home directly.
              </p>
              <div className="flex justify-center pt-8 md:pt-12">
                <Link href="/brands" className="h-14 md:h-16 px-10 md:px-14 rounded-full bg-amber-500 text-emerald-950 text-sm font-black shadow-2xl transition-all hover:bg-amber-400 hover:scale-105 flex items-center justify-center gap-3">
