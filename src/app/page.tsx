        ...
        <div className="standard-container">
          ...
          <div className="flex flex-col gap-8 md:gap-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              ...
              {/* <Link href="/products" className="group h-12 px-8 rounded-full bg-emerald-950/5 text-emerald-950 border border-emerald-950/10 text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-emerald-950 hover:text-white transition-all shadow-sm shrink-0 whitespace-nowrap md:mb-2">
