      ...
      >
         ...
         >
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
               ...
               <Link href="/seller/payouts" className="text-[10px] font-black uppercase tracking-widest text-[#059669] hover:text-emerald-800 flex items-center gap-2">
         ...
         <motion.div variants={itemVariants} className="bg-white rounded-[3rem] border border-slate-100 p-10 space-y-8 relative overflow-hidden shadow-sm">
            <div className="flex items-center justify-between relative z-10">
               ...
               <Link href="/seller/orders" className="text-[10px] font-black uppercase tracking-widest text-[#059669] hover:text-emerald-800 flex items-center gap-2">
