  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-5 duration-1000">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-4xl font-black text-[var(--admin-sidebar)] tracking-tighter">Business Intelligence</h2>
          <p className="text-slate-400 font-medium text-sm mt-1">Real-time performance metrics for Namma Orru ecosystem.</p>
        </div>
